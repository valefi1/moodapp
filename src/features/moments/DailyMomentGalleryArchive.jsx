                  ...
                  <article key={moment.id} className="overflow-hidden rounded-2xl border border-gray-100 bg-white dark:border-white/10 dark:bg-gray-950/50">
                    <div className="relative h-40 bg-black">
                      {moment.signedUrl
                        ...
                        : <div className="grid h-full place-items-center p-4 text-center text-xs font-bold text-white">{moment.mediaLoading ? 'Načítám moment…' : moment.locked ? 'Šifrovaný moment' : 'Náhled není dostupný'}</div>}
